import { EaCJSRDistributedFileSystemDetails, isEaCJSRDistributedFileSystemDetails, parseEaCJSRDistributedFileSystemDetails } from "../../../src/dfs/_/EaCJSRDistributedFileSystemDetails.ts";
